...
public class FrgWodeMenzhengguahaodan extends BaseFrg {
    ...
    public void loaddata() {
        mMPageListView.setDataFormat(new DfWodeMenzhengguahaodan());
        mMPageListView.setApiUpdate(ApisFactory.getApiMCropOutpatientList().set(type));
        mMPageListView.pullLoad();
